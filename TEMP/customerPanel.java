	...
	public customerPanel() {
		...
		cusTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String genderText = tblModel.getValueAt(cusTable.getSelectedRow(), 2).toString();
				String dobText = tblModel.getValueAt(cusTable.getSelectedRow(), 3).toString();
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (nameInput.getText().isEmpty())
					...
					Object[] employeeData = { name, phone, gender,
