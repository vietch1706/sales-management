...
public class productPanel extends JPanel {
	...
	public productPanel() {
		...
		infoPanel.setBounds(25, 155, 350, 510);
		...
		prodTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String dateText = tblModel.getValueAt(prodTable.getSelectedRow(), 3).toString();
				String wrtText = tblModel.getValueAt(prodTable.getSelectedRow(), 4).toString();
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (nameInput.getText().isEmpty())
					...
					Object[] productData = {prodName, price, quantity, 
							simpleDateFormat.format(importDate)
							, warranty, code};
					nameInput.setText("");
					priceInput.setText("");
					qtyInput.setText("");
